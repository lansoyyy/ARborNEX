...
import 'package:landscape/screens/details_screen.dart';
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            //             style: TextStyle(
            //                 fontSize: 16.0, height: 1.5, color: Colors.black54),
            //           ),
            //         ],
            //       ),
            //     ),
                        ...
                        return index == 2
                            ? Padding(
                                ...
                                child: _buildZoomableImage(context,
                                    'assets/images/indoor${index + 1}.jpg'),
                              )
                            : Padding(
                                padding: const EdgeInsets.all(5.0),
                                child: _buildZoomableImage(context,
                                    'assets/images/indoor${index + 1}.png'),
                              );
                      },
                    ),
                  )
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => const DetailsScreen(
              ...
              projectDescription:
                  'I bring a unique blend of horticulture expertise, landscape creativity, and dedication to every project. With a strong background in plant selection, garden design, and sustainable landscaping practices, I’m committed to delivering high-quality results that align with your vision and enhance your outdoor space. My attention to detail, problem-solving skills, and focus on client satisfaction make me an ideal choice for your landscaping needs.',
              additionalInfo: 'Additional information for project 1.',
              likes: "123",
            ),
          ),
        );
                        ...
                        itemBuilder: (context, index) {
                          return index == 0
                              ? Padding(
                                  padding: const EdgeInsets.all(5.0),
                                  child: _buildZoomableImage(context,
                                      'assets/images/balcony${index + 1}.jpg'),
                                )
                              : Padding(
                                  padding: const EdgeInsets.all(5.0),
                                  child: _buildZoomableImage(context,
                                      'assets/images/balcony${index + 1}.png'),
                                );
                        },
                      ),
                    )
                        ...
                        itemBuilder: (context, index) {
                          return index == 0
                              ? Padding(
                                  padding: const EdgeInsets.all(5.0),
                                  child: _buildZoomableImage(context,
                                      'assets/images/outdoor${index + 1}.png'),
                                )
                              : Padding(
                                  padding: const EdgeInsets.all(5.0),
                                  child: _buildZoomableImage(context,
                        ...
                        itemBuilder: (context, index) {
                          return index == 0
                              ? Padding(
                                  padding: const EdgeInsets.all(5.0),
                                  child: _buildZoomableImage(context,
                                      'assets/images/traditional${index + 1}.jpg'),
                                )
                              : Padding(
                                  padding: const EdgeInsets.all(5.0),
                                  child: _buildZoomableImage(context,
